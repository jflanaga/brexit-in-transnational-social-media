...
def test_empty_hashtags(tweet):
    assert parse_tweets.hashtags(tweet) == ''


def test_empty_quoted_or_retweeted_hastags(tweet):
    assert parse_tweets.quoted_or_retweeted_hashtags(tweet) == ''
...
def test_empty_urls(tweet):
    assert parse_tweets.urls(tweet) == ''


def test_empty_retweet_id(tweet):
    assert parse_tweets.retweet_id(tweet) == ''


def test_empty_retweet_screen_name(tweet):
    assert parse_tweets.retweet_screen_name(tweet) == ''


def test_empty_retweet_user_id(tweet):
...
def test_empty_user_urls(tweet):
